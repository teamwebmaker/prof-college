<div class="card vacancy-card h-100 border-0 shadow-sm hover-shadow transition-all">
    <div class="card-body p-4 d-flex flex-column">
        <div class="d-flex justify-content-between align-items-start mb-3">
            <h3 class="h5 fw-bold mb-0 text-dark">{{ $vacancy->title }}</h3>
            <span class="badge bg-red bg-opacity-10 text-red rounded-pill px-3 py-2">
                <i class="bi bi-arrow-up-right me-1"></i> Open
            </span>
        </div>

        <div class="mt-auto">
            <a href="{{ asset('vacancies/'.$vacancy->file) }}" data-fancybox data-type="iframe"
                data-preload="false"
