...
<body data-languge="ka">
    ...
    <div class="wrapper " style="margin-top: 5rem;">
        ...
        <div class="container-xxl py-4">
            ...
            @session('success')
                <div class="col-lg-6">
                    <div class="alert alert-success w-50" role="alert" x-data="{ show: true }" x-show="show"
                ...
                <div class="col-lg-6">
                    <div class="text-box">
                        <div class="ratio ratio-4x3 ">
                            <iframe src="{{ asset('docs/static/visiting-college.pdf') }}"
                                title="Visiting College"></iframe>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="card p-4 h-100 form-card">
                        <form method="POST" action="{{ route('visitors.store', ['language' => app()->getLocale()]) }}">
                            @csrf
                            <div class="mb-4">
                                <input type="text" class="form-control form-field" placeholder="რეგიონი / ქალაქი"
                                    name="region" />
                            </div>
                            <div class="mb-4">
                                <input type="text" class="form-control form-field" placeholder="რაიონი"
                                    name="district" />
                            </div>
                            <div class="mb-4">
                                <input type="text" class="form-control form-field" placeholder="სკოლა" name="school"
                                    required />
                            </div>
                            <div class="mb-4">
                                <input type="date" class="form-control form-field data-field" placeholder="თვე/დღე/წელი"
                                    name="date" pattern="\d{2}/\d{2}/\d{4}" required />
                            </div>
                            <div class="mb-4">
                                <input type="number" class="form-control form-field"
                                    placeholder="საკონტაქტო პირის ტელეფონი" name="phone" required />
                            </div>
