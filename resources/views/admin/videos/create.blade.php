...
@section('main')
    ...
    <div class="row">
        <div class="col-md-12">
            <form method="POST"  action="{{ route('videos.store', ['language' => app() -> getLocale()]) }}" enctype="multipart/form-data">
                @csrf
                <nav>
                ...
                <div class="mb-3">
                    <input type="text" class="form-control" name="url" placeholder="ლინკი(EMBED)" required/>
                </div>
